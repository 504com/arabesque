 ...
 * include: xxxxjquery.exif.js (http://www.nihilogic.dk/labs/exifjquery/)
 * set exifData: true
	...
	$.mbGallery ={
      ...
      galleryDesc.html(gallery.images[gallery.idx].description);
		...
		buildNav:function(){
			...
			var thumbsIcon =  $("<div/>")
					.attr("title", "afficher/masquer grille des photos")
			...
			var startStopIcon =  $("<div/>")
					.attr("title", "démarrer/arrêter animation photos")
			...
			var prevIcon =  $("<div/>")
					.attr("title", "photo précedente")
					.addClass("prevIcon ico")
					.bind("click", function () {
				$(gallery).mb_galleryPrev();
			});
			var nextIcon =  $("<div/>")
					.attr("title", "photo suivante")
